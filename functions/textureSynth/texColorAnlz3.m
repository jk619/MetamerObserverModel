function [params] = texColorAnlz3(im0, Nsc, Nor, Na)

% Same as texColorAnlz2, but imposing the autocorrelation
% to the low-pass versions of the images, as in textureXXX3.m 
%
% Analyze texture for application of Portilla-Simoncelli model/algorithm.
%
% [params] = texColorAnlz3(im0, Nsc, Nor, Na);
